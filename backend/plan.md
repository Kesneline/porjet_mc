...
*Refuser les attaques basiques de deny-of-service*
...
*Pouvoir tracker les bugs et erreurs en production*
...
*Avoir confiance que les critical paths marchent*
...
*Terminer les features partielles, ajouter features MVP manquantes*
...
**Qui**: Backend Dev
**Status**: Partially done (avatar upload exists)
...
*Production readiness, monitoring, documentation*
